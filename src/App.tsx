...
const VIDEOS = [
  { id: 0, title: "Special Preview", src: "/Download.mp4" },
  { id: 1, title: "Eddsworld Animation #01", src: "/Download (1).mp4" },
  { id: 2, title: "Eddsworld Animation #02", src: "/Download (2).mp4" },
  { id: 3, title: "Eddsworld Animation #03", src: "/Download (3).mp4" },
  { id: 4, title: "Eddsworld Animation #04", src: "/Download (4).mp4" },
  { id: 5, title: "Eddsworld Animation #05", src: "/Download (5).mp4" },
  { id: 6, title: "Eddsworld Animation #06", src: "/Download (6).mp4" },
  { id: 7, title: "Eddsworld Animation #07", src: "/Download (7).mp4" },
  { id: 8, title: "Eddsworld Animation #08", src: "/Download (8).mp4" },
  { id: 9, title: "Eddsworld Animation #09", src: "/Download 9.mp4" },
  { id: 10, title: "Eddsworld Animation #10", src: "/Download 10.mp4" },
  { id: 11, title: "Eddsworld Animation #11", src: "/Download 11.mp4" },
  { id: 12, title: "Eddsworld Animation #12", src: "/Download 12.mp4" },
  { id: 13, title: "Eddsworld Animation #13", src: "/Download 13.mp4" },
  { id: 14, title: "Eddsworld Animation #14", src: "/Download 14.mp4" },
  { id: 15, title: "Eddsworld Animation #15", src: "/Download 15.mp4" },
  { id: 16, title: "Eddsworld Animation #16", src: "/Download 16.mp4" },
];
...
const VideoCard: React.FC<VideoProps> = ({ video, idx, onSelect }) => {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-cool-black/20" />
    ...
    <div className="min-h-screen pb-32 selection:bg-pop-pink selection:text-white bg-deep-blue text-white">
      ...
      <footer className="mt-60 px-6 max-w-6xl mx-auto text-center">
        ...
        <p className="text-[9px] text-white/20 font-bold uppercase tracking-[0.4em]">
          © 2026 ONIKA STUDIO / ARTWORK BY ONIKA / INSPIRED BY EDDSWORLD
        </p>
      </footer>
    </div>
  );
